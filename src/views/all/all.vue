...
<div>
    <div class="df w1220 f-column a-center ">
        ...
        <div class="df  order_box w1220 a-center h50">
            <div class=" p-l-r-10 order_item" @click="comprehensiveSorting()">综合排序</div>
            <div class=" p-l-r-10 order_item" @click="priceLowToHigh()">价格从低到高</div>
            <div class=" p-l-r-10 order_item" @click="priceHighToLow()">价格从高到低</div>
...
export default {
    ...
    methods: {
        ...
        goToDetail(item) {
            ...
            window.open(`../detail?id=${item.productId}`)
