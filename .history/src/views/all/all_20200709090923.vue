    ...
    <div class="df w1220 f-column a-center ">
        ...
        <div>
            <div class="loop_box j-bettween w1220">
                ...
                <div @click="goToDetail(item)" @mouseenter="enterArea(index)" @mouseleave="leaveArea(index)" class="  df f-column a-center j-center loop" v-for="(item,index) in list" :key="index">
