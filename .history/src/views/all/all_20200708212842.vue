...
<div>
    <div class="df w1220 f-column a-center ">
        ...
        <div class="df r1 order_box w1220 a-center h50">
            <div class=" p-l-r-10 ">综合排序</div>
            <div class=" p-l-r-10 ">价格从低到高</div>
            <div class=" p-l-r-10 ">价格从高到低</div>
            <div class="inputs">
                  <input type="text">-<input type="text"> <Button type="primary">Primary</Button>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="pageNation df f-column  ">
                <div class="j-end page_item"><Page @on-change="onChange" @on-page-size-change="onPageSizeChange" :total="16" size="small" :page-size-opts=[8,16] :page-size='8' show-total show-sizer show-elevator /></div>
            </div>
        </div>
