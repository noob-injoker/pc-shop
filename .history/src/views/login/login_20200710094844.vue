    ...
    <div class="login f-column  a-center ">
        ...
        <div>
            ...
            <i-form v-ref:form-validate :model="formValidate" :rules="ruleValidate" :label-width="80">
                <Form-item label="username" prop="name">
                    <i-input :value.sync="formValidate.password" placeholder="请输入姓名"></i-input>
                </Form-item>
                <Form-item label="password" prop="name">
                    <i-input :value.sync="formValidate.name" placeholder="请输入密码"></i-input>
                </Form-item>
