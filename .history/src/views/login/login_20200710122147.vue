...
<div class="box ccc">
    <div class="login f-column  a-center ">
        ...
        <i-form ref='formValidate' :model="formValidate" :rules="ruleValidate" :label-width="80">
            ...
            <Form-item>
                <div class="df r1 a-center j-center">
                    <div @click="handleSubmit('formValidate')" class="ccc r1 login_box1">
                        <i-button type="primary">登录</i-button>
                    </div>
                    <div @click="handleSubmit('formValidate')" class="ccc r1 login_box">
