...
<div>
    ...
    <div class="box ccc b1">

        <div class="box1 df r1">
            <div class="pic1 r1" v-if="datailList">
                <div v-for="(item,index) in datailList.productImageSmall" :key="index">
                    <div class="img_box b1 ccc">
                      <img :src="item" alt="">
                    </div>
                </div>
            </div>
