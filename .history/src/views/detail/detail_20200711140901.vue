        ...
        <div class="box1  df ">
            ...
            <div class=" w450 m-l-20" v-if="datailList">
                ...
                <div class="number m-t-20 df a-center">
                    ...
                    <div>数量</div>
                    <div class="df m-l-15">
                        <div class="del ccc fs16 ">
                           -
                        </div>
                        <div class="count_num">999</div>
                        <div class="add ccc fs16 ">+</div>
                ...
                <div class="df btns_box">
                    <div @click="goToShopCart(datailList)">
...
export default {
    ...
    methods: {
        ...
        goToShopCart(datailList){
            
            this.$router.push({name:'datailList',query:{
                datailList:this.datailList
            }})
        }
...
.del,.add{
    ...
    height: 20px;
    border-radius: 50% 50%;
    box-shadow: 0px 0px 8px rgb(168, 166, 166);
}
.product {
    background: #EDEDED;
